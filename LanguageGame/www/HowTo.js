...
LanguageGame.HowTo.prototype = {
    ...
    addWordagaInstructions: function(){
        var h2 = this.add.bitmapText(this.world.centerX - 200, 300, 'eightbitwonder','Wordaga Game', 26);
        var wordInstruct = 'Click on the words that\nmatch the given word';
